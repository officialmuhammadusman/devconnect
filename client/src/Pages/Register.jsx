          ...
          <div className="p-8">
            <Formik
              ...
              onSubmit={async (values, { setSubmitting }) => {
                try {
                  console.log(
                    "Submitting registration form with values:",
                    values
                  );
                  ...
                  if (profileImage) {
                    ...
                    console.log("Profile image attached:", profileImage.name);
                  }
                  ...
                  <div>
                    ...
                    <div className="grid md:grid-cols-2 gap-4 mt-4">
                      ...
                      <div className="relative">
                        ...
                        <div className="relative">
                          <FaCode className="absolute top-1/2 left-3 transform -translate-y-1/2 text-gray-400" />
                          <Field
                            as="select"
                            name="category"
                            className="pl-10 w-full bg-gray-50 border-2 border-gray-200 rounded-xl py-3 px-4 outline-none focus:border-blue-500 focus:bg-white text-gray-900 placeholder-gray-500 transition-all duration-200"
