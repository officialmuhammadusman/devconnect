...
const Navbar = () => {
  ...
  const [notifications] = useState([
    {
      id: 1,
      icon: <FaThumbsUp className="text-deep-cosmos-teal text-xl" />,
    ...
    {
      id: 2,
      icon: <FaComment className="text-deep-cosmos-teal text-xl" />,
      text: "Sarah commented on your project",
      time: "2 hours ago",
      read: false,
      link: "/notifications"
    },
    {
      id: 3,
      icon: <FaUserFriends className="text-deep-cosmos-magenta text-xl" />,
  ...
  const [messages] = useState([
    {
      id: 1,
      avatar: <FaUserCircle className="text-deep-cosmos-light-grey text-2xl" />,
      name: "Alex Johnson",
      preview: "Hey, about our project meeting tomorrow...",
      time: "10:30 AM",
      unread: true,
      link: "/chat"
    },
    {
      id: 2,
      avatar: <FaUserCircle className="text-deep-cosmos-light-grey text-2xl" />,
      name: "Team DevConnect",
      preview: "Weekly newsletter: New features released!",
      time: "Yesterday",
      unread: false,
      link: "/chat"
    }
  ...
  const developerCategories = [
    {
      id: 1,
      icon: <FaLaptopCode className="text-deep-cosmos-teal text-lg" />,
      name: "Frontend",
      link: "/all-developers?category=frontend"
    },
    {
      id: 2,
      icon: <FaServer className="text-deep-cosmos-teal text-lg" />,
      name: "Backend",
      link: "/all-developers?category=backend"
    },
    {
      id: 3,
      icon: <FaLaptopCode className="text-deep-cosmos-teal text-lg" />,
      name: "Full Stack",
      link: "/all-developers?category=fullstack"
    },
    {
      id: 4,
      icon: <FaRobot className="text-deep-cosmos-gold text-lg" />,
      name: "AI/ML",
      link: "/all-developers?category=aiml"
    },
    {
      id: 5,
      icon: <FaMobileAlt className="text-deep-cosmos-magenta text-lg" />,
      name: "Mobile Devs",
      link: "/all-developers?category=mobile"
    }
  ];
          ...
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:flex flex-1 justify-center">
              <div className="flex items-center space-x-4 lg:space-x-6">
                <Link 
                  to="/" 
                  className="flex items-center text-deep-cosmos-white hover:text-deep-cosmos-teal transition-all px-3 py-2 rounded-md text-sm font-medium"
                  onClick={scrollToTop}
                >
                ...
                <div className="relative" ref={dropdownRef}>
                  ...
                  {isDropdownOpen && (
                    <div className="absolute left-1/2 transform -translate-x-1/2 mt-2 w-56 bg-deep-cosmos-secondary rounded-lg shadow-xl py-2 z-50 border border-deep-cosmos-grey">
                      <Link 
                        to="/all-developers" 
                        className="flex items-center px-4 py-3 text-deep-cosmos-light-grey hover:text-deep-cosmos-teal transition-all"
                        onClick={() => setIsDropdownOpen(false)}
                      >
                        <FaUserFriends className="mr-3 text-deep-cosmos-light-grey" />
            ...
            <div className="flex items-center space-x-2 sm:space-x-4">
              {isLoggedIn ? (
                <>
                  ...
                  <div className="relative hidden md:block" ref={notificationRef}>
                    <button 
                      ...
                      className="p-2 rounded-full text-deep-cosmos-white hover:text-deep-cosmos-teal transition-all relative"
                    >
                    ...
                    {isNotificationDropdownOpen && (
                      <div className="absolute right-0 mt-2 w-80 bg-red-600 rounded-lg shadow-xl py-1 z-50 border border-deep-cosmos-grey">
                        <div className="px-4 py-3 border-b border-deep-cosmos-grey flex justify-between items-center bg-deep-cosmos-primary rounded-t-lg">
                          ...
                          <Link 
                            to="/notifications" 
                            className="text-sm text-deep-cosmos-teal hover:text-deep-cosmos-teal transition-all"
                        ...
                        <div className="max-h-96 overflow-y-auto">
                          {notifications.map(notification => (
                            <Link 
                              ...
                              className={`flex items-start px-4 py-3 text-deep-cosmos-light-grey hover:text-deep-cosmos-teal transition-all ${!notification.read ? 'bg-deep-cosmos-teal/20' : ''}`}
                              onClick={() => setIsNotificationDropdownOpen(false)}
                            >
                              ...
                              {!notification.read && (
                                <div className="ml-2 w-2 h-2 bg-deep-cosmos-teal rounded-full"></div>
                              )}
                            </Link>
                          ))}
                        </div>
                        ...
                        <div className="max-h-96 overflow-y-auto">
                          {messages.map(message => (
                            <Link
                              key={message.id}
                              to={message.link}
                              className={`flex items-start px-4 py-3 text-deep-cosmos-light-grey hover:text-deep-cosmos-teal transition-all ${message.unread ? 'bg-deep-cosmos-teal/20' : ''}`}
                              onClick={() => setIsMessageDropdownOpen(false)}
                            >
                  ...
                  <div className="relative" ref={profileRef}>
                    ...
                    {isProfileDropdownOpen && (
                      <div className="absolute right-0 mt-2 w-48 bg-deep-cosmos-secondary rounded-lg shadow-xl py-2 z-50 border border-deep-cosmos-grey">
                        ...
                        >
                          <FaUserCircle className="mr-3 text-deep-cosmos-light-grey" />
                          <span>Profile</span>
                        </Link>
                        <Link 
                          to="/edit-profile" 
                          ...
                          onClick={() => setIsProfileDropdownOpen(false)}
                        >
                          <FaCog className="mr-3 text-deep-cosmos-light-grey" />
                        ...
                        <button 
                          ...
                          className="w-full text-left flex items-center px-4 py-3 text-deep-cosmos-light-grey hover:text-deep-cosmos-teal transition-all"
                        >
                          <FaSignOutAlt className="mr-3 text-deep-cosmos-light-grey" />
                          <span>Logout</span>
                        </button>
                      </div>
                    )}
                ...
                <>
                  <div className="hidden md:flex items-center space-x-4">
                    ...
                    <Link 
                      to="/register" 
                      className="bg-deep-cosmos-white text-deep-cosmos-primary px-4 py-2 rounded-md hover:text-deep-cosmos-teal transition-all flex items-center text-sm font-medium"
                    >
              ...
              <div className="md:hidden">
                <button 
                  ...
                  className="p-2 rounded-md text-deep-cosmos-white hover:text-deep-cosmos-teal transition-all"
                >
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden bg-deep-cosmos-secondary border-t border-deep-cosmos-grey shadow-lg">
            <div className="px-4 py-3 space-y-1 max-h-[calc(100vh-80px)] overflow-y-auto">
              ...
              <Link 
                to="/" 
                className="flex items-center text-deep-cosmos-white hover:text-deep-cosmos-teal transition-all px-3 py-3 rounded-md text-base font-medium"
                onClick={() => {
                  scrollToTop();
                  setIsMobileMenuOpen(false);
                }}
              ...
              <div className="space-y-1">
                <button 
                  onClick={toggleDropdown}
                  className="flex items-center justify-between w-full text-deep-cosmos-white hover:text-deep-cosmos-teal transition-all px-3 py-3 rounded-md text-base font-medium"
                >
                ...
                {isDropdownOpen && (
                  <div className="ml-6 space-y-1 bg-deep-cosmos-primary rounded-md py-2">
                    <Link 
                      to="/all-developers" 
                      className="block px-4 py-2 text-deep-cosmos-light-grey hover:text-deep-cosmos-teal transition-all"
                      onClick={() => {
                        setIsDropdownOpen(false); 
                        setIsMobileMenuOpen(false);
                      }}
              ...
              {isLoggedIn ? (
                <>
                  <div className="border-t border-deep-cosmos-grey pt-3 mt-4 space-y-1">
                    <div className="px-3 py-2 text-xs font-semibold text-deep-cosmos-light-grey uppercase tracking-wider">
                      Account
                    </div>
                    <Link 
                      to="/notifications" 
                      className="flex items-center justify-between text-deep-cosmos-white hover:text-deep-cosmos-teal transition-all px-3 py-3 rounded-md text-base font-medium"
                      onClick={() => setIsMobileMenuOpen(false)}
                    >
                      <div className="flex items-center">
                        <IoMdNotificationsOutline className="mr-3 text-lg" />
                        <span>Notifications</span>
                      </div>
                      {unreadNotifications > 0 && (
                        <span className="bg-deep-cosmos-magenta text-deep-cosmos-white text-xs rounded-full h-5 w-5 flex items-center justify-center">
                          {unreadNotifications}
                        </span>
                      )}
                    </Link>
                    ...
                    >
                      <div className="flex items-center">
                        <BsFillChatDotsFill className="mr-3 text-lg" />
                        <span>Messages</span>
                      </div>
                      {unreadMessages > 0 && (
                        <span className="bg-deep-cosmos-gold text-deep-cosmos-white text-xs rounded-full h-5 w-5 flex items-center justify-center">
                          {unreadMessages}
                        </span>
                      )}
                    </Link>
                    ...
                    <button 
                      ...
                      className="w-full text-left flex items-center text-deep-cosmos-white hover:text-deep-cosmos-teal transition-all px-3 py-3 rounded-md text-base font-medium"
                    >
                ...
                <div className="border-t border-deep-cosmos-grey pt-4 mt-4 space-y-3">
                  ...
                  <Link 
                    to="/login" 
                    className="flex items-center justify-center bg-deep-cosmos-primary text-deep-cosmos-teal px-4 py-3 rounded-lg text-base font-medium hover:text-deep-cosmos-teal transition-all mx-3"
                    onClick={() => setIsMobileMenuOpen(false)}
                  >
                  ...
                  <Link 
                    to="/register" 
                    className="flex items-center justify-center bg-deep-cosmos-white text-deep-cosmos-primary px-4 py-3 rounded-lg text-base font-medium hover:text-deep-cosmos-teal transition-all mx-3"
                    onClick={() => setIsMobileMenuOpen(false)}
                  >
